    ...
    <>
      <DarkModeProvider>
        ...
        <ToastProvider>
          ...
          <Showcase panelNum={8} title="This website" desc="Well? I made it myself using react and tailwind and no other frontend related libraries. Still buggy and not very impressive, I am still working on it lol." show_path="/gif/personal.gif" />
